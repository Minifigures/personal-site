...
export const skills: Skill[] = [
  ...
  { name: "Gradient Boosting", category: "framework" },
  { name: "SVM", category: "framework" },
  { name: "Feature Engineering", category: "framework" },
  { name: "Cross-Validation", category: "framework" },
