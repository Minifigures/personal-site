...
export function Island() {
  ...
  return (
    <group position={islandPosition}>
      ...
      {/* Palm trees, trunk base grounded to the dome surface */}
      <PalmTree position={[0, 2.05, 0]} height={3.5} rotation={0} />
      <PalmTree position={[-3.0, 1.88, 1.5]} height={3.0} rotation={1.2} lean={0.2} />
      <PalmTree position={[3.5, 1.85, -1.2]} height={3.2} rotation={2.5} />
      <PalmTree position={[-1.2, 1.92, -2.5]} height={2.5} rotation={4.0} lean={0.1} />
      <PalmTree position={[1.8, 1.89, 2.5]} height={2.8} rotation={5.5} lean={0.18} />
      {/* Smaller background trees */}
      <PalmTree position={[5.0, 1.67, 0.5]} height={2.0} rotation={0.8} />
      <PalmTree position={[-4.5, 1.73, -1.0]} height={2.2} rotation={3.5} lean={0.12} />
...
export function SmallIsland() {
  ...
  return (
    <group position={position}>
      ...
      {/* Palm trees grounded to the dome surface */}
      <PalmTree position={[-2.5, 1.43, 1.2]} height={2.8} rotation={2.0} />
      <PalmTree position={[3.0, 1.27, 1.8]} height={2.2} rotation={0.8} lean={0.2} />
      <PalmTree position={[-1.5, 1.44, -2.0]} height={2.0} rotation={4.5} />
...
export function TinyIsland() {
  ...
  return (
    <group position={position}>
      ...
      {/* Palm trees grounded to the dome surface */}
      <PalmTree position={[0, 1.05, 0]} height={2.5} rotation={1.0} />
      <PalmTree position={[-1.5, 0.95, -0.5]} height={1.8} rotation={3.2} lean={0.15} />
